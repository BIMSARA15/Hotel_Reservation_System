...
<head>
    ...
    <title>Hotel Viyamba</title>
    <link rel="stylesheet" href="./sigirihotel2.css">
    ...
    <section class="sigiri" id="sigirib">
        ...
        <section class="cony">
            <div class="slide-wrapper2">
                    ...
                    <div class="slider2">
                        <img id="slide2-1" src="./img/sigiri_hotel2.jpg" />
                        <img id="slide2-2" src="./img/sigiri_hotel2_1.webp">
                        <img id="slide2-3" src="./img/sigiri_hotel2_3.jpg" />
                        <img id="slide2-4" src="./img/sigiri_hotel2_2.jpg" />
                        <img id="slide2-5" src="./img/sigiri_hotel2_4.webp" />
...
<script>
    const c = document.querySelector(".sigiri");
    ...
    function slides2(name) {
        ...
        if (name == "slider2-1") {
            backDiv.style.backgroundImage = "url('./img/sigiri_hotel2.jpg')";
        } else if (name == "slider2-2") {
            backDiv.style.backgroundImage = "url('./img/sigiri_hotel2_1.webp')";
        } else if (name == "slider2-3") {
            backDiv.style.backgroundImage = "url('./img/sigiri_hotel2_3.jpg')";
        } else if (name == "slider2-4") {
            backDiv.style.backgroundImage = "url('./img/sigiri_hotel2_2.jpg')";
        }  else if (name == "slider2-5") {
            backDiv.style.backgroundImage = "url('./img/sigiri_hotel2_4.webp')";
        }    else {
            alert("Invalid!!");
        }
            ...
            <section class="foodb" id="foodbb">
                <section class="cony2">
                    <div class="slide-wrapper3">
                        <div class="slider3">
                            <img id="slide3-1" src="./img/sfood5.jpg" />
                            <img id="slide3-2" src="./img/sfood6.jpg">
                            <img id="slide3-3" src="./img/sfood7.jpg" />
                            <img id="slide3-4" src="./img/sfood8.webp" />
        ...
        <script>
            ...
            function slides3(name) {
                ...
                if (name == "slider3-1") {
                    backDiv.style.backgroundImage = "url('./img/sfood5.jpg')";
                   document.getElementById("para3").innerHTML="Lorem ipsum dolor sit amet consectetur adipisicing elit. Et tempora ea eius nesciunt nostrum vitae iure minima ullam dolorem dolores sequi error qui accusamus, aut maxime laudantium est necessitatibus? Aperiam!";
                    ...
                    backDiv.style.backgroundImage = "url('./img/sfood6.jpg')";
                    ...
                    backDiv.style.backgroundImage = "url('./img/sfood7.jpg')";
                    document.getElementById("para3").innerHTML="Lorem ipsum dolor sit amet consectetur adipisicing elit. Et tempora ea eius nesciunt nostrum vitae iure minima ullam dolorem dolores sequi error qui accusamus, aut maxime laudantium est necessitatibus? Aperiam!";
                } else if (name == "slider3-4") {
                    backDiv.style.backgroundImage = "url('./img/sfood8.webp')";
                    document.getElementById("para3").innerHTML="iure minima ullam dolorem dolores sequi error qui accusamus, aut maxime laudantium est necessitatibu";
                }  else {
                    alert("Invalid!!");
                }
                       ...
                       <div class="box">
                           <p>Location <span>*</span></p>
                            <select name="location" class="input" required>
                               <option value="Sigirya">Sigiriya</option>
                              </select>
                               </div>
                    <div class="box">
