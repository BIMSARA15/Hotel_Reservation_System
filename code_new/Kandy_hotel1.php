...
<head>
    ...
    <title>Hotel Kandurata</title>
    <link rel="stylesheet" href="./kandyhotel1.css">
...
<body>
    ...
    <section class="cony">
        <div class="slide-wrapper2">
            ...
            <div class="slider2">
                <img id="slide2-1" src="./img/Kandy Hotel 1 (1).jpg" />
                <img id="slide2-2" src="./img/gallery-img-2.webp">
                <img id="slide2-3" src="./img/hotel2.jpg" />
                <img id="slide2-4" src="./img/hotel1.jpg" />
                <img id="slide2-5" src="./img/home-img-2.jpg" />
                <img id="slide2-6" src="./img/kandy3.jpg" />
        ...
        <script>
            ...
            function slides2(name) {
                ...
                if (name == "slider2-1") {
                    backDiv.style.backgroundImage = "url('./img/Kandy Hotel 1 (1).jpg')";
                } else if (name == "slider2-2") {
                    backDiv.style.backgroundImage = "url('./img/gallery-img-2.webp')";
                } else if (name == "slider2-3") {
                    backDiv.style.backgroundImage = "url('./img/hotel2.jpg')";
                } else if (name == "slider2-4") {
                    backDiv.style.backgroundImage = "url('./img/hotel1.jpg')";
                } else if (name == "slider2-5") {
                    backDiv.style.backgroundImage = "url('./img/home-img-2.jpg')";
    ...
    <section class="foodb" id="foodbb">
        <section class="cony2">
            <div class="slide-wrapper3">
                <div class="slider3">
                    <img id="slide3-1" src="./img/kfood1 (1).jpg" />
                    <img id="slide3-2" src="./img/kfood1 (2).jpg">
                    <img id="slide3-3" src="./img/kfood1 (3).jpg" />
                    <img id="slide3-4" src="./img/kfood1 (4).jpg" />
            ...
            <script>
                ...
                function slides3(name) {
                    ...
                    if (name == "slider3-1") {
                        backDiv.style.backgroundImage = "url('./img/kfood1 (1).jpg')";
                        ...
                        backDiv.style.backgroundImage = "url('./img/kfood1 (2).jpg')";
                        ...
                        backDiv.style.backgroundImage = "url('./img/kfood1 (3).jpg')";
                        document.getElementById("para3").innerHTML = "Lorem ipsum dolor sit amet consectetur adipisicing elit. Et tempora ea eius nesciunt nostrum vitae iure minima ullam dolorem dolores sequi error qui accusamus, aut maxime laudantium est necessitatibus? Aperiam!";
                    } else if (name == "slider3-4") {
                        backDiv.style.backgroundImage = "url('./img/kfood1 (4).jpg')";
                        document.getElementById("para3").innerHTML = "iure minima ullam dolorem dolores sequi error qui accusamus, aut maxime laudantium est necessitatibu";
                    } else {
                        alert("Invalid!!");
                    }
