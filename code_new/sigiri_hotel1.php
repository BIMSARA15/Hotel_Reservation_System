...
<head>
    ...
    <title>Sigiri Stay</title>
    <link rel="stylesheet" href="./sigirihotel1.css">
    ...
    <section class="sigiri" id="sigirib">
        ...
        <section class="cony">
            <div class="slide-wrapper2">
                    ...
                    <div class="slider2">
                        <img id="slide2-1" src="./img/sigiri_hotel1.jpg" />
                        <img id="slide2-2" src="./img/sigiri_hotel1_1.jpg">
                        <img id="slide2-3" src="./img/sigiri_hotel1_2.jpg" />
                        <img id="slide2-4" src="./img/sigiri_hotel1_4.jpg" />
                        <img id="slide2-5" src="./img/sigiri_hotel1_3.jpeg" />
...
<script>
    ...
    function slides2(name) {
        ...
        if (name == "slider2-1") {
            backDiv.style.backgroundImage = "url('./img/sigiri_hotel1.jpg')";
        } else if (name == "slider2-2") {
            backDiv.style.backgroundImage = "url('./img/sigiri_hotel1_1.jpg')";
        } else if (name == "slider2-3") {
            backDiv.style.backgroundImage = "url('./img/sigiri_hotel1_2.jpg')";
        } else if (name == "slider2-4") {
            backDiv.style.backgroundImage = "url('./img/sigiri_hotel1_4.jpg')";
        }  else if (name == "slider2-5") {
            backDiv.style.backgroundImage = "url('./img/sigiri_hotel1_3.jpeg')";
        }    else {
            alert("Invalid!!");
        }
            ...
            <section class="foodb" id="foodbb">
                <section class="cony2">
                    <div class="slide-wrapper3">
                        <div class="slider3">
                            <img id="slide3-1" src="./img/sfood1.jpeg" />
                            <img id="slide3-2" src="./img/sfood2.jpg">
                            <img id="slide3-3" src="./img/sfood3.jpg" />
                            <img id="slide3-4" src="./img/sfood4.jpg" />
        ...
        <script>
            ...
            function slides3(name) {
                ...
                if (name == "slider3-1") {
                    backDiv.style.backgroundImage = "url('./img/sfood1.jpeg')";
                   document.getElementById("para3").innerHTML="Lorem ipsum dolor sit amet consectetur adipisicing elit. Et tempora ea eius nesciunt nostrum vitae iure minima ullam dolorem dolores sequi error qui accusamus, aut maxime laudantium est necessitatibus? Aperiam!";
                    ...
                    backDiv.style.backgroundImage = "url('./img/sfood2.jpg')";
                    ...
                    backDiv.style.backgroundImage = "url('./img/sfood3.jpg')";
                    document.getElementById("para3").innerHTML="Lorem ipsum dolor sit amet consectetur adipisicing elit. Et tempora ea eius nesciunt nostrum vitae iure minima ullam dolorem dolores sequi error qui accusamus, aut maxime laudantium est necessitatibus? Aperiam!";
                } else if (name == "slider3-4") {
                    backDiv.style.backgroundImage = "url('./img/sfood4.jpg')";
                    document.getElementById("para3").innerHTML="iure minima ullam dolorem dolores sequi error qui accusamus, aut maxime laudantium est necessitatibu";
                }  else {
                    alert("Invalid!!");
                }
