...
<head>
    ...
    <title>Hotel Araliya</title>
    <link rel="stylesheet" href="./kandyhotel2.css">
...
<body>
    ...
    <section class="cony">
        <div class="slide-wrapper2">
            ...
            <div class="slider2">
                <img id="slide2-1" src="./img/kandy2 (5).jpg" />
                <img id="slide2-2" src="./img/kandy2 (3).jpg">
                <img id="slide2-3" src="./img/kandy2 (4).jpg" />
                <img id="slide2-4" src="./img/kandy2 (2).jpg" />
                <img id="slide2-5" src="./img/home-img-1.jpg" />
        ...
        <script>
            ...
            function slides2(name) {
                ...
                if (name == "slider2-1") {
                    backDiv.style.backgroundImage = "url('./img/kandy2 (5).jpg')";
                } else if (name == "slider2-2") {
                    backDiv.style.backgroundImage = "url('./img/kandy2 (3).jpg')";
                } else if (name == "slider2-3") {
                    backDiv.style.backgroundImage = "url('./img/kandy2 (4).jpg')";
                } else if (name == "slider2-4") {
                    backDiv.style.backgroundImage = "url('./img/kandy2 (2).jpg')";
                } else if (name == "slider2-5") {
                    backDiv.style.backgroundImage = "url('./img/home-img-1.jpg')";
                } else {
                    alert("Invalid!!");
                }
                tl2.fromTo(c, {
    ...
    <section class="foodb" id="foodbb">
        <section class="cony2">
            <div class="slide-wrapper3">
                <div class="slider3">
                    <img id="slide3-1" src="./img/kfood2 (2).jpg" />
                    <img id="slide3-2" src="./img/kfood2.jpg">
                    <img id="slide3-3" src="./img/kfood2 (1).jpg" />
                    <img id="slide3-4" src="./img/kfood3.jpg">
            ...
            <script>
                ...
                function slides3(name) {
                    ...
                    if (name == "slider3-1") {
                        backDiv.style.backgroundImage = "url('./img/kfood2 (2).jpg')";
                        ...
                        backDiv.style.backgroundImage = "url('./img/kfood2.jpg')";
                        ...
                        backDiv.style.backgroundImage = "url('./img/kfood2 (1).jpg')";
                        document.getElementById("para3").innerHTML = "Lorem ipsum dolor sit amet consectetur adipisicing elit. Et tempora ea eius nesciunt nostrum vitae iure minima ullam dolorem dolores sequi error qui accusamus, aut maxime laudantium est necessitatibus? Aperiam!";
                    } else if (name == "slider3-4") {
                        backDiv.style.backgroundImage = "url('./img/kfood3.jpg')";
                        document.getElementById("para3").innerHTML = "iure minima ullam dolorem dolores sequi error qui accusamus, aut maxime laudantium est necessitatibu";
                    } else {
                        alert("Invalid!!");
                    }
