...
*::-webkit-scrollbar-thumb{
    ...
    border-radius: 5rem;
        ...
        #back {
            height: max-content;
            background-image: url("./img/kandy3.jpg");
        ...
        .bttn6 {
            ...
            margin-left: 20px;
            font-size: 30px;
            background-image: url('./img/Kandy\ Hotel\ 1\ \(2\).jpg');
            background-size: cover;
            background-repeat: no-repeat;
            font-weight: bold;
            color: transparent;
...
<body>
    ...
    <section id="back" class="backbb">
        ...
        <section class="container">
            <div class="slide-wrapper">
                <div class="slider">
                    <img id="slide-1" src="./img/kandy3.jpg" />
                    <img id="slide-2" src="./img/back1.jpg">
                    <img id="slide-3" src="./img/kandy4.jpg" />
                    <img id="slide-4" src="./img/kandy2.jpg" />
                    <img id="slide-5" src="./img/kandy.jpg" />
                    <img id="slide-6" src="./img/back4.jpg" />
                    <img id="slide-7" src="./img/general2.jpg" />
    ...
    <div class="gen" id="genb">
        ...
        <a href="Kandy_hotel1.php"><button id="btn5" class="bttn5" a href="#"> Hotel Kandurata </button></a>
        <a href="Kandy_hotel2.php"><button id="btn5" class="bttn6" a href="#"> Hotel Araliya </button></a>
