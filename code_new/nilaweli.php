...
*::-webkit-scrollbar-thumb{
    ...
    border-radius: 5rem;
        ...
        #back {
            height: max-content;
            background-image: url("./img/nilaveli1.jpg");
...
<body>
    <section id="back" class="backbb">
        ...
        <section class="container">
            <div class="slide-wrapper">
                <div class="slider">
                    <img id="slide-1" src="./img/nilaveli1.jpg" />

                    <img id="slide-3" src="./img/nilaveli3.jpg" />
                    <img id="slide-4" src="./img/nilaveli5 (1).jpg" />
                    <img id="slide-5" src="./img/nilaveli6.jpg" />
    ...
    <div class="gen" id="genb">
        ...
        <a href="nilaweli_hotel1.php"><button id="btn5" class="bttn5" a href="#"> Hotel Ocean </button></a>
        <a href="nilaweli_hotel2.php"><button id="btn5" class="bttn6" a href="#"> Hotel Helios </button></a>
